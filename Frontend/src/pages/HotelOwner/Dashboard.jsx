...
const Dashboard = () => {
  ...
  const {currency, user, getToken, toast, axios, baseURL} = useAppContext();
  ...
  const fetchDashboardData = async () => {
    try {
      const {data} = await axios.get(`${baseURL}/api/bookings/hotel`, {headers: {Authorization: `Bearer ${await getToken()}`}})
  ...
  return (
    <div>
      ...
      {/* -------- Recent Bookings -------- */}
      <h1 className='text-xl text-blue-950/70 font-medium mb-5'>Recent Bookings</h1>
